...
The `rāvòtifsimpábàb'ádi` project (or just `rāvòzò'ádi` or `rāvòz'ádi` for short, anglicized Rāvòz) is a spiritual artlang (also known by its autonym `tābòkò'af`) with a non-linear writing system.
